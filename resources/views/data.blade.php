                    ...
                    <div class="form-group">
                        ...
                        <div class="btn-group btn-group-toggle w-50" data-toggle="buttons">
                            <label class="btn bg-danger active">
                                <input type="radio" name="traType" id="option_b1" value="0" autocomplete="off"
                                    checked=""> Debit
                            </label>
                            <label class="btn bg-success">
                                <input type="radio" name="traType" id="option_b2" value="1" autocomplete="off">
                                Credit
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="btn-group btn-group-toggle w-100" data-toggle="buttons">
                            ...
                            <label class="btn bg-warning">
                                <input type="radio" name="traMethod" id="option_b5" value="4" autocomplete="off">
                                Amazon Pay
                            </label>
                            <label class="btn bg-dark">
                                <input type="radio" name="traMethod" id="option_b6" value="5" autocomplete="off">
                                Card
                            </label>
                            <label class="btn bg-danger">
                                <input type="radio" name="traMethod" id="option_b7" value="6" autocomplete="off">
                                Cheque
                            </label>
                        </div>
                    </div>
